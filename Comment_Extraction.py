...
def get_params():
    params={'key': 'AIzaSyDJXDQ7-SFzTj6lMBz3AX8HAGGTubHqY-g', 'videoId': video_id, 'part': 'snippet,id,replies',
...
# Converting into csv
with open('C:/Users/Meghna/Desktop/comments.csv', 'w',encoding='utf8',newline='') as myfile:
